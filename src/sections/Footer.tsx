...
const resourceLinks = [
  ...
  { label: 'USSD Code Cost', href: '/guides/ussd-code-cost-kenya' },
  { label: 'Bulk Email Marketing', href: '/guides/bulk-email-kenya' },
  { label: 'SMS Surveys', href: '/guides/sms-survey-kenya' },
  { label: 'API Documentation', href: '/developers/docs' },
  { label: 'SMS API Kenya', href: '/sms-api-kenya' },
  { label: 'WhatsApp API Pricing', href: '/whatsapp-api-pricing-kenya' },
  { label: 'M-Pesa Daraja API', href: '/mpesa-daraja-api-kenya' },
  { label: 'USSD Pricing Kenya', href: '/ussd-pricing-kenya' },
